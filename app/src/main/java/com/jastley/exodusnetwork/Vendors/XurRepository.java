...
public class XurRepository {
    ...
    private MutableLiveData<XurVendorModel> vendorModel = new MutableLiveData<>();
                ...
                .subscribe(xurData -> {
                            ...
                            if(!xurData.getResponse().getStatus().equals("200")) {
                                ...
                                try {
                                    ...
                                    XurVendorModel model = new XurVendorModel(xurData.getResponse().getData().getLocation().getWorld(),
                                            region,
                                            xurData.getResponse().getData().getLocation().getId());

                                    vendorModel.postValue(model);
                                }
                                catch(Exception e) {
                        ...
                        }, throwable -> snackbarMessage.postValue(new SnackbarMessage(throwable.getLocalizedMessage()))
                );


    }

    public MutableLiveData<XurVendorModel> getLocationLiveData() {
        return vendorModel;
    }
    ...
    public void getXurVendor() {
        ...
        Disposable disposable = authRetrofit.create(BungieAPI.class)
                ...
                .subscribe(xurVendor -> {
                    ...
                    //Error
                    if(!xurVendor.getErrorCode().equals("1")) {
