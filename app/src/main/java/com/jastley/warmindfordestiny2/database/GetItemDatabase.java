...
//                            Call<JsonObject> getCollectablesManifest = bungieClient.getCollectablesDatabase();
//
...
//
//                                                    List<DestinyFactionDefinition> factionList = new ArrayList<>();
//
...
//
//                                                        DestinyFactionDefinition factionModel = new DestinyFactionDefinition();
//
//                                                        factionModel.setId(key);
