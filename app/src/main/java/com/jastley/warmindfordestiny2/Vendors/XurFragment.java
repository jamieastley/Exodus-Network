...
public class XurFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_xur, container, false);
...
//                .subscribe(response -> {
//
//                    String vendorLocation = response.getResponse().getVendor().getData().getVendorLocationIndex();
//                });
    }
